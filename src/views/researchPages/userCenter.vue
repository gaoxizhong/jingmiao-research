    ...
    <el-row :gutter="10" class="row-bg" type="flex">
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
        <div class="grid-content">
          ...
          <div class="grid-content-item">邮箱：<span>{{userInfo.email?userInfo.email:'暂无'}}</span></div>
          <div class="grid-content-item">单位名称：<span>{{userInfo.company_name?userInfo.company_name:'暂无'}}</span></div>
          <div class="grid-content-item">部门：<span>{{userInfo.department?userInfo.department:'暂无'}}</span></div>
        </div>
      </el-col>
      <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
